  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-10 space-y-8">
      ...
      >
        ...
        <div className="grid gap-2">
          <label className="text-sm font-medium text-slate-700">
            Describe the issue (help us prepare)
          </label>
          <textarea
            name="description"
            rows={4}
            placeholder="Example: Kitchen tap leaking under the sink. Started yesterday, slow drip. Need replacement tap if possible."
            className="rounded-md border border-slate-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-cyan-600"
            required
          />
        </div>
        ...
        {/* Hidden selected service (fallback) */}
